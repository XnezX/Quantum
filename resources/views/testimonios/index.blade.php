...
<div class="min-h-screen" x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' }"
    ...
    {{-- Título  --}}
    <h1 class="text-3xl font-bold text-center mb-10 text-gray-800 dark:text-gray-200">Testimonios</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="h-full flex flex-col">
                        <p class="text-lg mb-4 flex-grow dark:text-gray-300">SEPRINAL y su tecnología innovadora ha transformado por completo la forma en que operamos.</p>
                        <div class="mt-auto">
                            <p class="font-bold text-right dark:text-white">Felix Rojas</p>
                            <p class="text-gray-600 dark:text-gray-400 text-right">Director de Seguridad IPS</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="h-full flex flex-col">
                        <p class="text-lg mb-4 flex-grow dark:text-gray-300">Cada solución que nos han proporcionado SEPRINAL ha superado nuestras expectativas, brindándonos resultados duraderos y de alto rendimiento.</p>
                        <div class="mt-auto">
                            <p class="font-bold text-right dark:text-white">Aurora Pulido</p>
                            <p class="text-gray-600 dark:text-gray-400 text-right">Gerente de Administración La Costeña</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    <div class="h-full flex flex-col">
                        <p class="text-lg mb-4 flex-grow dark:text-gray-300">Es un placer contar con un proveedor que pone tanto énfasis en la excelencia y la fiabilidad de lo que ofrece.</p>
                        <div class="mt-auto">
                            <p class="font-bold text-right dark:text-white">Rodrigo Camacho</p>
                            <p class="text-gray-600 dark:text-gray-400 text-right">Gerente de T.I. SCS</p>
                        </div>
                    </div>
                </div>
            </div>
